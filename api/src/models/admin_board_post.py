...
마이그레이션 0040_admin_board + 0041_board_status_completed + 0064_board_feature_dev 와 1:1 매핑.
status: review(요청사항검토) | in_progress(수정중) | rejected(수정불가) | on_hold(보류)
        | completed(수정완료) | confirm_requested(컨펌요청) | confirmed(컨펌).
