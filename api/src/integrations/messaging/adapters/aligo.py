"""Aligo 알림톡·SMS 어댑터 — HOLD-MSG 해제 후 구현 예정 (AR35)."""

from api.src.integrations.messaging.port import AlimtalkResult

_HOLD_MSG = "Aligo 어댑터: HOLD-MSG 해제 후 구현. AR35(공급자 확정) 참조."
...
class AligoMessagingAdapter:
    ...
    2. Aligo REST API: https://www.aligo.in/
    3. MESSAGING_PROVIDER=aligo 로 전환
    """
