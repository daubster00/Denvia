...
AUDIT_ADMIN_DM_DELETE = "admin_dm.delete"               # 관리자 → 특정 사용자 1:1 쪽지 회수(hard delete)
...
AUDIT_PROMPT_CREATE = "prompt.create"                   # 관리자 신규 프롬프트 블록 생성
AUDIT_PROMPT_DELETE = "prompt.delete"                   # 관리자 생성 프롬프트 블록 삭제
...
AUDIT_LOGIN_BRUTE_THRESHOLD_UPDATE = "login_brute_threshold.update"  # 로그인 실패 이상탐지 기준 횟수 편집
AUDIT_ANOMALY_THRESHOLDS_UPDATE = "anomaly_thresholds.update"        # 이상탐지 통합 임계값 편집 (6 카테고리 11 항목)
